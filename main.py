...
def main(page: ft.Page):
    ...
    # header
        header = ft.Container(
            content=ft.Row([
                ...
                ft.Text("XP/XF", expand=1, text_align=ft.TextAlign.CENTER, weight=ft.FontWeight.BOLD, color="#1E293B", size=13),
    ...
    tables_layout = build_tables_list()
